...
useEffect(() => {
  ...
  <div className="flex gap-3">
    <Link
      to="/project-tracker"
      className="bg-indigo-600 hover:bg-indigo-500 px-5 py-2.5 rounded-lg text-white text-sm font-medium shadow transition duration-200"
    >
      Open Project Tracker →
    </Link>
    <Link
      to="/overdue"
      className="bg-red-600 hover:bg-red-500 px-5 py-2.5 rounded-lg text-white text-sm font-medium shadow transition duration-200"
    >
      ⚠️ View Overdue Tasks
        ...
        {/* Summary Cards */}
        <section className="bg-gray-900 border border-gray-800 p-6 sm:p-8 rounded-xl shadow-md">
          <SummaryCards />
        </section>
...
<section className="bg-gray-900 border border-gray-800 p-6 sm:p-8 rounded-xl shadow-md">
  <TaskReminders />
        ...
        {/* 🔔 Reminders Section */}
        {reminders.length > 0 && (
          <section className="bg-gray-900 border border-yellow-600 p-6 sm:p-8 rounded-xl shadow-md space-y-4">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-900 p-6 sm:p-8 rounded-xl shadow-md">
            <DashboardShortcuts />
          </div>
          <div className="bg-gray-900 p-6 sm:p-8 rounded-xl shadow-md">
            <ExportControls />
        ...
        {/* Activity Feed */}
        <section className="bg-gray-900 p-6 sm:p-8 rounded-xl shadow-md">
          <ActivityFeed />
        </section>
      </div>
    </div>
